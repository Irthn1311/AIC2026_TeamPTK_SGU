...
def test_telemetry_propagation_retrieval_only(fake_runtime):
    ...
    t = resp["timings"]
    assert t["coarse_requested_frame_count"] == 0
    assert t["coarse_decoded_frame_count"] == 0
    assert t["fine_requested_frame_count"] == 0
    assert t["fine_decoded_frame_count"] == 0
    assert t["coarse_sparse_request_count"] == 0
    assert t["coarse_sparse_success_count"] == 0
    assert t["coarse_sparse_fallback_count"] == 0
...
def test_telemetry_propagation_sequential(fake_runtime):
    ...
    t = resp["timings"]
    assert t["coarse_requested_frame_count"] == 60
    assert t["coarse_decoded_frame_count"] == 900
    assert t["fine_requested_frame_count"] == 180
    assert t["fine_decoded_frame_count"] == 300
    assert t["coarse_sparse_request_count"] == 0
    assert t["coarse_sparse_success_count"] == 0
    assert t["coarse_sparse_fallback_count"] == 0
...
def test_telemetry_propagation_sparse(fake_runtime):
    fake_outcome = QueryRefinementOutcome(
        ...
        timings={
            "refined_candidate_count": 3,
            "decoded_frame_count": 360,
            "encoded_image_count": 100,
            "coarse_requested_frame_count": 60,
            "coarse_decoded_frame_count": 60,
            "fine_requested_frame_count": 180,
            "fine_decoded_frame_count": 300,
            "coarse_sparse_request_count": 3,
            "coarse_sparse_success_count": 3,
            "coarse_sparse_fallback_count": 0,
            "video_probe_seconds": 0.0,
            "video_open_seconds": 0.0,
            "coarse_decode_seconds": 0.0,
    ...
    t = resp["timings"]
    assert t["coarse_requested_frame_count"] == 60
    assert t["coarse_decoded_frame_count"] == 60
    assert t["fine_requested_frame_count"] == 180
    assert t["fine_decoded_frame_count"] == 300
    assert t["coarse_sparse_request_count"] == 3
    assert t["coarse_sparse_success_count"] == 3
    assert t["coarse_sparse_fallback_count"] == 0
...
def test_telemetry_propagation_fallback(fake_runtime):
    fake_outcome = QueryRefinementOutcome(
        ...
        timings={
            ...
            "encoded_image_count": 100,
            "coarse_requested_frame_count": 60,
            "coarse_decoded_frame_count": 500,
            "fine_requested_frame_count": 180,
            "fine_decoded_frame_count": 300,
            "coarse_sparse_request_count": 3,
            "coarse_sparse_success_count": 2,
            "coarse_sparse_fallback_count": 1,
            "video_probe_seconds": 0.0,
            "video_open_seconds": 0.0,
            "coarse_decode_seconds": 0.0,
            "coarse_encode_seconds": 0.0,
    ...
    t = resp["timings"]
    assert t["coarse_requested_frame_count"] == 60
    assert t["coarse_decoded_frame_count"] == 500
    assert t["fine_requested_frame_count"] == 180
    assert t["fine_decoded_frame_count"] == 300
    assert t["coarse_sparse_request_count"] == 3
    assert t["coarse_sparse_success_count"] == 2
    assert t["coarse_sparse_fallback_count"] == 1
