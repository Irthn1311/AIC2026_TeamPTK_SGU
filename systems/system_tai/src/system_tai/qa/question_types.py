...
_OBJECT_ENTITY_PATTERNS = (
    ...
    r"\bcon vat (?:nao|gi)\b",
    r"\bdung cu gi\b",
    r"\bngoi (?:phia )?(?:tren|sau) vat gi\b",
    r"\bvat kim loai\b",
    r"\bdoan xe .* loai xe gi\b",
    r"\bthuc hien (?:nghe|hoat dong) gi\b",
    r"\bnghe thu cong gi\b",
    r"\bdang lam gi\b",
    r"\bboi canh nao\b",
    r"\bloai dia hinh nao\b",
    r"\bhien thi canh gi\b",
    r"\bwhat animal\b",
    r"\bwhat tool\b",
    r"\bwhat instrument\b",
    r"\bwhat craft\b",
    r"\bwhat activity\b",
    r"\bin what setting\b",
    r"\bwhat type of terrain\b",
    r"\bwhat scene is displayed\b",
    r"\bwhat is (?:he|she|the person) sitting\b",
    r"\bwhat are the .* doing\b",
)
