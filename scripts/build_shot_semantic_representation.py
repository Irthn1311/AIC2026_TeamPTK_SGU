...
def build_shot_semantic_representations(
    ...
    """Build and save Stage 3A Shot Semantic Representations."""
    ...
    logger.info("Building representations for %d shots...", total_shots)
...
def main():
    parser = argparse.ArgumentParser(
        description="Stage 3A: Build Shot Semantic Representations for TRIAGE-EG"
    )
    parser.add_argument(
        "--shots",
